...
export default class old_ProjectHtml {

    public static Generate(project: Project, target: string, source: DiskItemType) {
    ...
    ${old_ProjectHtml.style}

    ${old_ProjectHtml.script}
